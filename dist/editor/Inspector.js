export class Inspector {
    ...
    updateEntityProperty(propertyName, value) {
        if (this.currentEntity) {
            this.currentEntity.props[propertyName] = value;
        }
    }
    getPropertyFields(entityType) {
        return this.propertyFields.get(entityType) || [];
    }
    addPropertyField(entityType, field) {
    ...
    renderPropertyField(field, currentValue) {
    ...
    importEntityData(entityData) {
        this.loadEntity(entityData);
    }
    validateProperties(entityType, props) {
        const errors = [];
        const fields = this.getPropertyFields(entityType);
        fields.forEach(field => {
