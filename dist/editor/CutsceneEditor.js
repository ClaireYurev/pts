export class CutsceneEditor {
    ...
    getItemAt(x, y) {
        ...
        if (trackIndex < 0 || trackIndex >= this.cutscene.tracks.length)
            return null;
    ...
    createCutscene(name, duration = 10000) {
        const cutscene = {
...
//# sourceMappingURL=CutsceneEditor.js.map