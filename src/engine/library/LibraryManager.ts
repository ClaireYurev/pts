...
export class LibraryManager {
    private vfs: VFS;
    private registry: Map<string, LibraryItem> = new Map();
    private currentPack: string | null = null;
    ...
    private async initLibraryDB(): Promise<void> {
        try {
     ...
     */
    private async loadRegistryFromDB(): Promise<void> {
        if (!this.idb) {
            return;
        }
     ...
     */
    private async saveRegistryToDB(): Promise<void> {
        if (!this.idb) {
            return;
        }
     ...
     */
    async loadPackFromUrl(url: string): Promise<LibraryItem> {
        try {
            // Validate URL
     ...
     */
    async loadPackFromFile(file: File): Promise<LibraryItem> {
        try {
            // Validate file type
     ...
     */
    async installLocalPack(itemId: string): Promise<void> {
     ...
     */
    async switchPack(packId: string): Promise<GamePack> {
     ...
     */
    private validatePack(data: any): GamePack {
