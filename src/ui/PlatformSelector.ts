import { PlatformManager, PlatformConfig } from "../engine/PlatformConfig.js";
...
export class PlatformSelector {
    ...
    private onPlatformChange?: (platformKey: string) => void;
    private pauseManager?: PauseManager;
    private piMenu?: PiMenuInterface;
    ...
    private setupEventListeners(): void {
        ...
        categoryBtns.forEach(btn => {
            const categoryClickHandler = (e: Event) => {
        ...
        this.eventListeners.push({ element: document, type: 'keydown', listener: keydownHandler as (e: Event) => void });
    }



    private renderPlatforms(category: string = 'all'): void {
        ...
        if (category === 'all') {
            ...
            platforms = PlatformManager.getPlatformsByCategory(category as any);
        }
    ...
    private createPlatformCard(platform: PlatformConfig): HTMLDivElement {
    ...
    private getPlatformKey(platform: PlatformConfig): string {
    ...
    public setPlatformChangeCallback(callback: (platformKey: string) => void): void {
    ...
    public setPiMenu(piMenu: PiMenuInterface): void {
        this.piMenu = piMenu;
    }

    public isPlatformSelectorVisible(): boolean {
